...
class SurveyResponse(models.Model):
    ...
    feature_5 = models.SmallIntegerField(choices=FEATURE_RANK_CHOICES, help_text="Email Communications")
    feature_6 = models.SmallIntegerField(choices=FEATURE_RANK_CHOICES, help_text="Customer Relations")
